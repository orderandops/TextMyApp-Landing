          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="max-w-xl animate-in fade-in slide-in-from-bottom-6 duration-700">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button size="lg" variant="outline" className="border-primary/30 text-primary hover:bg-primary/5 text-base h-13 px-8 font-medium" onClick={() => Supademo.open('cmobjoexe0068zp0jx8npv94d')} data-testid="button-hero-demo">
